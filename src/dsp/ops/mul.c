...
int hvx_mul_f32(float *restrict dst, const float *restrict a, const float *restrict b, int n) {
    ...
    for (int i = 0; i < n_vecs; ++i) {
        ...
        HVX_Vector prod   = Q6_Vsf_equals_Vqf32(Q6_Vqf32_vmpy_VsfVsf(va_sf, vb_sf));
